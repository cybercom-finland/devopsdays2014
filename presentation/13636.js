...
(function() {
  ...
  function receiveSize(e) {
    if (e.origin === apiHost) {
      var event = e.data[0];
      var data  = e.data[1];
      if (event == 'asciicast:size' && data.id == 13636) {
  ...
  function insertPlayer(script) {
    ...
    container.id = "asciicast-container-13636";
    ...
    iframe.src = apiUrl + "/asciicasts/13636" + params(container, script);
    iframe.id = "asciicast-iframe-13636";
    iframe.name = "asciicast-iframe-13636";
    iframe.scrolling = "no";
  ...
  var script = document.getElementById("asciicast-13636");
