...
(function() {
  ...
  function receiveSize(e) {
    if (e.origin === apiHost) {
      var event = e.data[0];
      var data  = e.data[1];
      if (event == 'asciicast:size' && data.id == 13650) {
  ...
  function insertPlayer(script) {
    ...
    container.id = "asciicast-container-13650";
    ...
    iframe.src = apiUrl + "/asciicasts/13650" + params(container, script);
    iframe.id = "asciicast-iframe-13650";
    iframe.name = "asciicast-iframe-13650";
    iframe.scrolling = "no";
  ...
  var script = document.getElementById("asciicast-13650");
